...
public class TrackerControllerTestsface
{
    ...
    public TrackerControllerTestsface()
    {
        ...
        _controller = new TrackerController(_fakeApplicationService.Object, _fakeUserService.Object,
            _fakeTrackService.Object, _fakeConfig.Object, fakeToastNotification.Object);
    }
