...
public interface IEmailSendingService
{
    ...
    /// </summary>
    Task SendSchedulesToInterviewer(string fullname, string userEmail, string jobOpeningTitle, DateOnly date,
        string scheduledTimes, string meetingType);
    ...
    /// </summary>
    /// <returns></returns>
    Task SendRejectedScheduleNoticeToInterviewer(string email, string fullname, UserSchedule userSchedule,
        string applicantFullName);

    /// <summary>
    ///     Sends the accepted schedule with Teams link to the interviewer.
    /// </summary>
    Task SendAcceptedScheduleToInterviewer(string email, string fullname, UserSchedule userSchedule,
        ApplicationViewModel application, string joinUrl);

    /// <summary>
    ///     Sends the accepted schedule with Teams link to the applicant.
    /// </summary>
    Task SendAcceptedScheduleToApplicant(string email, UserSchedule userSchedule, ApplicationViewModel application,
        string joinUrl);
