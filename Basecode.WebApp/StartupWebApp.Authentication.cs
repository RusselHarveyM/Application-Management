...
public partial class StartupWebApp
{
    private void ConfigureAuth(IServiceCollection services)
    {
        ...
        services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
        {
            ...
            {
                ClockSkew = TimeSpan
                    .Zero, // Clock skew compensates for server time drift.We recommend 5 minutes or less
                ...
                ValidateIssuer =
                    true, // Validate if the token was issued by a trusted authorization server (default true)
