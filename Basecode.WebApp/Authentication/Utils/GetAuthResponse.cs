...
public class GetAuthResponse
{
        ...
        return new TokenProviderOptions
        {
            ...
            Expiration =
                TimeSpan.FromMinutes(
                    Convert.ToInt32(Configuration.Config.GetSection("Basecode:ExpirationMinutes").Value)),
    ...
    /// <returns></returns>
    public static LoginViewModel Execute(ClaimsIdentity identity, BasecodeContext db, IdentityUser userName,
        RefreshToken refreshToken = null)
    {
        ...
        var jwt = new JwtSecurityToken(
            ...
            identity.Claims,
            DateTime.UtcNow,
            DateTime.UtcNow.Add(options.Expiration),
