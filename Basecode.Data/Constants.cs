...
public static class Constants
{
    ...
    {
        public const string ErrorProcessing =
            "An error was encountered while processing the request. Please refresh the page and try again. If the problem still occurs, contact your administrator.";
    ...
    public static class SMTP
    {
        ...
        public static string EmailName => "JumpStart Email";
    }
    ...
    public static class Upload
    {
        ...
        public static string RootUploadPath = ConfigurationManager.AppSettings["RootUploadPath"];
    }
    ...
    {
        public const string ExcelTable =
            "<!DOCTYPE HTML><html><body><table border='1'><tr><td>This is a sample file. This a sample file.</td></tr></table></body></html>";

        public const string PDFContent =
            "<!DOCTYPE HTML><html><body><table border='1'><tr><td>This is a sample file. This a sample file.</td></tr></table></body></html>";
    }
}